...
def update_data(n, val):  # inpur parameter(s)
    if n == None:
        return "Hey there! Please enter a legitimate stock code to get details.", "https://img.etimg.com/thumb/height-450,width-800,imgsize-18948,msid-88090092/dalal-street-week-ahead-stay-vigilant-till-nifty-finds-a-bottom.jpg", "Stock Deals", None, None, None
        # raise PreventUpdate
    else:
        if val == None:
            raise PreventUpdate
